...
export const content = cva(
  'data-[state=open]:animate-contentShow bg-white dark:bg-neutral-900 dark:text-white fixed top-[50%] left-[50%] w-auto max-w-[850px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none',
);
